...
function buildCreatorData(videos, metric) {
  ...
  // Urutkan dari yang tertinggi berdasarkan metrik yang sedang dipilih
...
export default function TrendChart({ videos, metric }) {
  ...
  // Chart butuh lebih tinggi + label dimiringkan kalau creator-nya banyak,
  // supaya nama tidak saling tumpuk.
